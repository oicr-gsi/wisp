...
# One sample inside a REDUX output directory. Named rather than discovered, because a control
# pool is usually one directory holding every sample, and which of them a run wants is the
# caller's decision.
struct ReduxSample {
    String sample_id
    String redux_dir
